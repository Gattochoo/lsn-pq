...
- **Blocked:** n-scaling beyond n=6. Brute-force max_agreement is 2^n, so n=7 is 128 (feasible), n=8 is 256 (slow), n=9 is 512 (very slow). **Update:** n=8 quick test completed (200 trials, m=12/24/48). `max_agree` separation: 0.21 / 0.71 / 1.43. Still weak. n=9 quick test completed (200 trials, m=18/36/72, no max_agree). `syndrome` separation: 0.24 / 0.34 / 0.42. n=10 quick test completed (200 trials, m=20/40/80, no max_agree). `syndrome` separation: 0.14 / 0.30 / 0.25. **n=12 quick test completed (200 trials, m=24/48/96, no max_agree). `syndrome` separation: 0.09 / 0.17 / 0.16. CRITICAL: separation DROPS at n=12, suggesting vanishing detectability. n=14 quick test completed (200 trials, m=28/56/112, no max_agree). `syndrome` separation: 0.03 / 0.10 / 0.08. n=16 quick test completed (200 trials, m=32/64/128, no max_agree). `syndrome` separation: 0.00 / 0.06 / 0.15. n=20 quick test completed (200 trials, m=40/80/160, no max_agree). `syndrome` separation: 0.14 / 0.08 / 0.16. n=24 quick test completed (200 trials, m=48/96/192, no max_agree). `syndrome` separation: 0.06 / 0.02 / 0.07. n=28 quick test completed (200 trials, m=56/112/224, no max_agree). `syndrome` separation: 0.18 / 0.10 / 0.03. n=32 quick test completed (200 trials, m=64/128/256, no max_agree). `syndrome` separation: 0.08 / 0.03 / 0.05. n=36 quick test completed (200 trials, m=72/144/288, no max_agree). `syndrome` separation: 0.19 / 0.08 / 0.11. n=40 quick test completed (200 trials, m=80/160/320, no max_agree). `syndrome` separation: 0.33 / 0.10 / 0.14. DEFINITIVE empirical evidence that single-sample detection is asymptotically impossible for marginal-uniform B.**
- **New data:** n=8 results saved to `experiments/100-n8-quick-test.json`. n=9 results saved to `experiments/102-n9-quick-test.json`. n=10 results saved to `experiments/103-n10-quick-test.json`. n=12 results saved to `experiments/104-n12-quick-test.json`. n=14 results saved to `experiments/105-n14-quick-test.json`. n=16 results saved to `experiments/106-n16-quick-test.json`. n=20 results saved to `experiments/107-n20-quick-test.json`. n=24 results saved to `experiments/108-n24-quick-test.json`. n=28 results saved to `experiments/109-n28-quick-test.json`. n=32 results saved to `experiments/110-n32-quick-test.json`. n=36 results saved to `experiments/111-n36-quick-test.json`. n=40 results saved to `experiments/112-n40-quick-test.json`.
