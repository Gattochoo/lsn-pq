...
**→ $k=2$ pencil은 asymptotically $2 \times$ threshold.** $k \ge 3$은 threshold 아래 (n=3 제외). 이건 `experiments/80` 수치와 일치.
...
|-----|-------|-----------|-----------|-----------|
| 3 | 1.7313 | 2.3103 | **2.3103** | — |
| 4 | 1.8762 | 2.6667 | **3.0457** | 4.5714 |
| 5 | 1.9390 | 2.8421 | **3.5716** | 5.7143 |
| 6 | 1.9692 | 2.9206 | **3.8111** | 6.3492 |
| 8 | 1.9922 | 2.9767 | **3.9538** | 6.6977 |
| 10 | 1.9980 | 2.9922 | **3.9883** | 6.9767 |

**관찰:**
- $R_{n,2} \to 4$ from below (exact limit: $2^2 \cdot 2 / 2 = 4$).
- $R_{n,3} \to 8$ from below (exact limit: $2^3 \cdot 2 / 2 = 8$), but $k=3$ pencils are below threshold.
...
- **Ratio = $4.0 / 1.7313 = 2.3103$** — 이건 $R_{3,2}$가 아니라 $R_{3,1}$과 같음 (주의: $n=3$에서 $n-k=1$, $E_1=1$, $2^2 \cdot 1 / 1.7313 = 2.3103$).
