...
|---:|---:|---:|---:|---|---|
| 3 | $49/64 \approx 0.766$ | $4069/4096 \approx 0.993$ | $\approx 0.836$ | `[4,2,1,1]` | `[0,0,0,0]` |
| 4 | $241/256 \approx 0.941$ | $65455/65536 \approx 0.999$ | $\approx 0.961$ | `[8,4,2,1]` | `[0,0,0,0]` |
...
> **$n=2$ non-adaptive 설정에서 lem:m2 성립에 강한 정량적 증거가 나왔다.**

$m=3,4$ 범위에서, $2n$차원 correlated noise 구조가 $(C,y)$ 전체를 위조하는 것을 막는다. 이는 `lem:m2`의 직관 — “고정 $2n$차원 잡음이 i.i.d. Bernoulli를 위조 못 한다” — 를 $n=2$에서 정량적으로 뒷받침한다. 단, 이는 $n=2$ non-adaptive $B$에 대한 수치적 증거이며 일반 증명은 아니다.
