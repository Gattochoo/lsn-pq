...
pub fn constant_time_inventory_json() -> &'static str {
    concat!(
        ...
        "      \"issue\": \"polar SCL path pruning uses data-dependent metrics, sorting, branching, heap-like vector growth, and floating-point operations; see experiments/186-codex-polar-scl-workshape-audit.json\",\n",
