...
pub fn scl_work_shape_audit_json() -> &'static str {
    concat!(
        ...
        "    {\"wrapper\": \"try_expand_then_compact_integer_round_schedule\", \"failure_family\": \"public_path_domain_failure_codes\", \"integer_status_family\": \"integer_schedule_domain_check\", \"status_field\": \"FixedSclPathBufferIntegerScheduleRun.domain_check + path_domain_check.failure_code\"}\n",
        "  ],\n",
