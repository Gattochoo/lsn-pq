...
The label-signal side of the secret-$B$ regime is controlled by the following affine-coset bias bound (proved via the MacWilliams identity; see the source-accuracy record for the derivation).
