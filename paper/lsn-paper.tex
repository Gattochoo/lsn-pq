...
\;\le\;
\frac{\log_2 \bigl(|\Lagr(2n,\F_2)|\cdot|GL(n,\F_2)|\bigr)+m+\delta nm+O(1)}{0.094n}
...
\]
which rearranges to $\E[k\mid A]\cdot0.094n\le(3/2)n^{2}+n/2+m+\delta nm+O(1)$.  Taking expectations over $A$ and $R$ gives the claimed bound.
\end{proof}
