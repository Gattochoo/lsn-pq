...
\Cref{thm:transport-fullrank} blocks full-rank linear reductions at \emph{every} $m \ge 2n$ and \emph{every} noise rate. The residual $m=\omega(n)$ gap is therefore reduced to near-full and mid-rank linear maps (see \Cref{tab:barriers}).
